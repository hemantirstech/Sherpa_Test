...
@Component({
  selector: 'app-converted-to-clients',
  templateUrl: './converted-to-clients.component.html',
  styleUrls: ['./converted-to-clients.component.scss'],
  providers: [AdvancedService, DecimalPipe],
})
export class ConvertedToClientsComponent implements OnInit {
  // bread crum data
