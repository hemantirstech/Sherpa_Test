...
function matches(tables: Table, term: string, pipe: PipeTransform) {
  return (
    tables.salesLeadContact.name.toLowerCase().includes(term.toLowerCase()) ||
    tables.salesLeadContact.designation.toLowerCase().includes(term) ||
    tables.companyName.toLowerCase().includes(term) ||
    tables.contactNo.toLowerCase().includes(term) ||
    tables.salesLeadContact.lastContacted.toLowerCase().includes(term) ||
    tables.salesLeadContact.name.toLowerCase().includes(term)
  );
}
